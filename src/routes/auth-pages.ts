...
.topbar{height:56px;padding:0 clamp(18px,4vw,44px);position:relative;z-index:2}.theme{min-width:44px;min-height:36px;border-radius:7px;font-size:12px;font-weight:700;color:var(--muted);transition:color 150ms ease,border-color 150ms ease,transform 150ms ease}.theme:hover{color:var(--text);border-color:var(--accent)}.theme:active{transform:translateY(1px)}
...
.card{width:100%;max-width:440px;padding:32px;border:1px solid var(--border);border-radius:12px;box-shadow:0 18px 48px rgba(24,24,27,.07)}.card.wide{max-width:620px}.heading h1{letter-spacing:-.035em}.button{transition:background 150ms ease,border-color 150ms ease,color 150ms ease,transform 150ms ease,opacity 150ms ease}.button:active:not(:disabled){transform:translateY(1px)}.field input{transition:border-color 150ms ease,box-shadow 150ms ease,background 150ms ease}.auth-context-mobile{display:none;margin:0 0 20px;padding:12px 13px;border-left:3px solid var(--accent);background:color-mix(in srgb,var(--accent) 7%,var(--surface));color:var(--muted);font-size:13px}.auth-context-mobile strong{display:block;color:var(--text);margin-bottom:2px}.footer{font-size:11px;color:var(--muted)}
...
@media(max-width:520px){.main{padding:24px 12px}.card{padding:24px 20px;border-radius:10px}.topbar{height:56px}.heading h1{font-size:26px}.form-row{align-items:flex-start}}
@media(prefers-reduced-motion:reduce){.button,.theme,.field input{transition-duration:.01ms}}
`;
