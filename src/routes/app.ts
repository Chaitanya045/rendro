...
<style>
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  html.dark .sidebar-tree{--sidebar-bg:#09090b;scrollbar-color:#71717a transparent}
  html.dark .sidebar-tree::-webkit-scrollbar-thumb{background:#71717a}
  html.dark .sidebar-tree::-webkit-scrollbar-thumb:hover{background:#a1a1aa}
