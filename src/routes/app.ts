...
<style>
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .resizer-sparks{position:absolute;left:50%;width:5px;height:5px;border-radius:999px;pointer-events:none;opacity:0;background:var(--resizer-spark-a);transform:translateX(-50%);filter:drop-shadow(0 0 5px rgba(249,115,22,.75));box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}
  ...
  @keyframes resizerImpactTop{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}18%{opacity:1;box-shadow:-7px 6px 0 1px var(--resizer-spark-a),8px 7px 0 1px var(--resizer-spark-b),-12px 10px 0 .5px var(--resizer-spark-b),13px 11px 0 .5px var(--resizer-spark-a),-17px 14px 0 .5px var(--resizer-spark-a),18px 15px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:-34px 29px 0 1px rgba(250,204,21,0),36px 30px 0 1px rgba(251,146,60,0),-48px 40px 0 .5px rgba(251,146,60,0),50px 42px 0 .5px rgba(250,204,21,0),-64px 54px 0 .5px rgba(250,204,21,0),66px 55px 0 .5px rgba(251,146,60,0)}}
  @keyframes resizerImpactBottom{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}18%{opacity:1;box-shadow:-7px -6px 0 1px var(--resizer-spark-a),8px -7px 0 1px var(--resizer-spark-b),-12px -10px 0 .5px var(--resizer-spark-b),13px -11px 0 .5px var(--resizer-spark-a),-17px -14px 0 .5px var(--resizer-spark-a),18px -15px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:-34px -29px 0 1px rgba(250,204,21,0),36px -30px 0 1px rgba(251,146,60,0),-48px -40px 0 .5px rgba(251,146,60,0),50px -42px 0 .5px rgba(250,204,21,0),-64px -54px 0 .5px rgba(250,204,21,0),66px -55px 0 .5px rgba(251,146,60,0)}}
  @keyframes resizerTopTrailLeft{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}12%{opacity:1;box-shadow:-8px 7px 0 1px var(--resizer-spark-a),-11px 9px 0 1px var(--resizer-spark-b),-14px 12px 0 .5px var(--resizer-spark-a),-17px 14px 0 .5px var(--resizer-spark-b),-20px 17px 0 .5px var(--resizer-spark-a),-23px 19px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:-54px 45px 0 1px rgba(250,204,21,0),-62px 52px 0 1px rgba(251,146,60,0),-70px 59px 0 .5px rgba(250,204,21,0),-78px 65px 0 .5px rgba(251,146,60,0),-86px 72px 0 .5px rgba(250,204,21,0),-94px 79px 0 .5px rgba(251,146,60,0)}}
  @keyframes resizerBottomTrailLeft{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}12%{opacity:1;box-shadow:-8px -7px 0 1px var(--resizer-spark-a),-11px -9px 0 1px var(--resizer-spark-b),-14px -12px 0 .5px var(--resizer-spark-a),-17px -14px 0 .5px var(--resizer-spark-b),-20px -17px 0 .5px var(--resizer-spark-a),-23px -19px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:-54px -45px 0 1px rgba(250,204,21,0),-62px -52px 0 1px rgba(251,146,60,0),-70px -59px 0 .5px rgba(250,204,21,0),-78px -65px 0 .5px rgba(251,146,60,0),-86px -72px 0 .5px rgba(250,204,21,0),-94px -79px 0 .5px rgba(251,146,60,0)}}
  @keyframes resizerTopTrailRight{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}12%{opacity:1;box-shadow:8px 7px 0 1px var(--resizer-spark-a),11px 9px 0 1px var(--resizer-spark-b),14px 12px 0 .5px var(--resizer-spark-a),17px 14px 0 .5px var(--resizer-spark-b),20px 17px 0 .5px var(--resizer-spark-a),23px 19px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:54px 45px 0 1px rgba(250,204,21,0),62px 52px 0 1px rgba(251,146,60,0),70px 59px 0 .5px rgba(250,204,21,0),78px 65px 0 .5px rgba(251,146,60,0),86px 72px 0 .5px rgba(250,204,21,0),94px 79px 0 .5px rgba(251,146,60,0)}}
  @keyframes resizerBottomTrailRight{0%{opacity:0;box-shadow:0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0),0 0 0 0 rgba(250,204,21,0),0 0 0 0 rgba(251,146,60,0)}12%{opacity:1;box-shadow:8px -7px 0 1px var(--resizer-spark-a),11px -9px 0 1px var(--resizer-spark-b),14px -12px 0 .5px var(--resizer-spark-a),17px -14px 0 .5px var(--resizer-spark-b),20px -17px 0 .5px var(--resizer-spark-a),23px -19px 0 .5px var(--resizer-spark-b)}100%{opacity:0;box-shadow:54px -45px 0 1px rgba(250,204,21,0),62px -52px 0 1px rgba(251,146,60,0),70px -59px 0 .5px rgba(250,204,21,0),78px -65px 0 .5px rgba(251,146,60,0),86px -72px 0 .5px rgba(250,204,21,0),94px -79px 0 .5px rgba(251,146,60,0)}}
